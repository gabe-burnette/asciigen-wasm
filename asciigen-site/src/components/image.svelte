    ...
    <div class="flex justify-center flex-col p-3 overflow-auto rounded-lg outline-1 outline-dashed">
      <div class="w-full h-full flex flex-col text-lg gap-2">
        ...
        <div class="flex justify-center flex-wrap gap-2">
          <button on:click={download_image} class=" hover:bg-green-100 bg-green-200 rounded-lg outline-1 outline-dashed w-[200px] p-1">Download</button>
        <button on:click={resetOptions} class="hover:bg-yellow-100 bg-yellow-200 rounded-lg outline-1 outline-dashed w-[200px] p-1">Reset Options</button>
        ...
        <button on:click={reloadImage} class="hover:bg-blue-100 bg-blue-200 rounded-lg outline-1 outline-dashed w-[200px] p-1">Refresh image</button>
        <button on:click={unloadImage} class="hover:bg-red-100 bg-red-200 rounded-lg outline-1 outline-dashed w-[200px] p-1">New image</button>
        <!-- <button on:click={reloadImage} class="hover:bg-gray-200 active:bg-gray-100 rounded-lg outline-1 outline-dashed w-[200px] p-1">Add to saved</button> -->
        <button class="hover:bg-cyan-100 bg-cyan-200 rounded-lg outline-1 outline-dashed w-[200px] p-1" on:click={changeTo}>Switch to text</button>
